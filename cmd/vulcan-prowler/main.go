...
var (
	...
	// CISCompliance is the vulnerability generated by the check when the it
	// does not receive any security level and the account has failed controls.
	...
	// CISLevel1Compliance is the vulnerability generated by the check when the
	// it receives a security level of 1 or less and the account has failed
	// controls.
	...
	// CISLevel2Compliance is the vulnerability generated by the check when the
	// it receives a security level of 2 or more and the account has failed
	// controls.
